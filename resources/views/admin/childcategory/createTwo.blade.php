                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="file" accept=".pdf"  name="file1" id="file1"   class="form-control">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="file" accept=".pdf"  name="file2" id="file2"   class="form-control">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="file" accept=".pdf"  name="file3" id="file3"   class="form-control">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="file" accept=".pdf"  name="file4" id="file4"   class="form-control">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="file" accept=".pdf"  name="file5" id="file5"   class="form-control">
