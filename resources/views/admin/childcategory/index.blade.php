                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{route('child-category.create')}}" style="margin-left: 30px;" class="btn btn-primary btn-sm float-right">Add New
                            </a>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($childcategory as $key=>$row)
                                    <tr>
                                        ...
                                        <td>{{$row->user->name}}</td>
                                        <td><a href="{{route('child-category.edit' , ['id'=>$row->id,'status'=>0])}}"  class="btn btn-sm btn-primary" title="edit">
