                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($about as $row)
                                    <tr>
                                        ...
                                        <td>{{$row->user->name}}</td>
                                        <td><a href="{{route('about.edit' , $row->id)}}" data-toggle="modal"
                                               data-target="#exampleModal{{$row->id}}" class="btn btn-sm btn-primary"
                                               data-toggle="tooltip" title="edit">
                                                <i class="fa fa-pen"></i> Edit
                                            </a>
                                            <a href="{{route('about.show' ,$row->id)}}" id="delete"
                                               class="btn btn-sm btn-danger" data-toggle="tooltip" title="edit">
                                                <i class="fa fa-times"></i> Delete
                                            </a>
                                            <a href="{{route('about.edit' , $row->id)}}" data-toggle="modal"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('about.update',$row->id)}}" method="post"
                                    ...
                                    <div class="modal fade" id="about{{$row->id}}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Details About</h5>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
