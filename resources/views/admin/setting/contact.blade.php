                                ...
                                @foreach($contact as $row)
                                    <tr>
                                        ...
                                        <td><a href="" data-toggle="modal"
                                            ...
                                            <a href="{{route('contact.show' ,$row->id)}}" id="delete"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('contact.update',$row->id)}}" method="post"
                                    ...
                                    <div class="modal fade" id="about{{$row->id}}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Details Contact</h5>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
